// Função principal que calcula o IMC, define a classificação, calcula o peso ideal por gênero e atualiza a tela
function calcularIMC() {
    ...
    if (altura < 0 || altura > 3.0) {
        alert("Erro: A altura deve estar entre 0 metros e 3.0 metros (somente em metros, sem conversão automática). Exemplo: 1.75");
        return;
    }
